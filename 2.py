...
def main():
    ...
    st.caption("맵 길이 3배 확장, 네온 그래픽 리뉴얼, 초반 계단 및 점프 구간 밸런스 완전 패치!")
    ...
    <body>
        ...
        <script>
            ...
            // 물리 매개변수 (인간의 반응속도 및 타이밍에 정밀 동기화)
            const GRAVITY = 1.35;
            ...
            function generateMap() {
                let map = [
                    // ================= 1. 초반 큐브 구간 (X: 20~90) : 인간이 쉽게 적응 가능한 박자감 =================
                    {x: 22, type: 2, y: 0}, // 단일 가시 (적응)
                    
                    // 리듬감 있는 2단 계단 수정을 통해 억울한 사망 제거
                    {x: 32, type: 1, y: 0}, 
                    {x: 35, type: 1, y: 1}, 
                    {x: 40, type: 2, y: 0}, // 계단 내린 후 가시
                    
                    {x: 46, type: 4, y: 2}, // 점프링
                    {x: 52, type: 1, y: 1}, {x: 53, type: 1, y: 1},
                    {x: 58, type: 3, y: 3, id: 1}, // 코인 1
                    {x: 64, type: 2, y: 0}, {x: 65, type: 2, y: 0}, // 2연속 가시
                    {x: 74, type: 1, y: 1}, 
                    {x: 78, type: 4, y: 2.5},
                    {x: 85, type: 2, y: 0},
                    ...
                    // ================= 3. 비행기 코스 (X: 100~190) =================
                    {x: 112, type: 1, y: 5}, {x: 112, type: 1, y: 6}, {x: 112, type: 1, y: 7}, 
                    {x: 112, type: 2, y: 0}, 
                    {x: 128, type: 5, y: 8}, {x: 128, type: 1, y: 1}, 
                    {x: 142, type: 3, y: 4, id: 2}, // 코인 2
                    {x: 158, type: 1, y: 3}, {x: 158, type: 1, y: 4}, 
                    {x: 172, type: 5, y: 8}, {x: 172, type: 2, y: 0},
                    {x: 186, type: 1, y: 2}, {x: 186, type: 1, y: 7},
                    ...
                    {x: 224, type: 1, y: 1}, {x: 226, type: 1, y: 2},
                    {x: 234, type: 4, y: 2},
                    {x: 242, type: 1, y: 2}, 
                    {x: 252, type: 3, y: 4, id: 3}, // 코인 3
                    {x: 262, type: 2, y: 0}, {x: 263, type: 2, y: 0},
                    {x: 273, type: 4, y: 2}, {x: 279, type: 4, y: 4},
                    ...
                    {x: 400, type: 7, y: 0},
                    {x: 412, type: 2, y: 0}, {x: 413, type: 2, y: 0},
                    {x: 422, type: 1, y: 1}, 
                    {x: 432, type: 4, y: 2},
                    {x: 440, type: 1, y: 0}
                ];
