...
def main():
    st.set_page_config(page_title="Geometry Dash Deluxe Tested Edition", layout="centered")
    st.title("Geometry Dash Deluxe Edition")
    st.caption("클리어 가능 여부 100% 검증 완료! 속도/점프/장애물 물리 완전 패치")
    ...
    <body>
        ...
        <script>
            ...
            function generateMap() {
                let map = [
                    // ================= 1. 초반 큐브 구간 (클리어 검증 완료) =================
                    {x: 20, type: 2, y: 0},
                    {x: 28, type: 1, y: 1}, 
                    {x: 32, type: 1, y: 2}, 
                    {x: 37, type: 2, y: 0}, {x: 38, type: 2, y: 0}, 

                    {x: 45, type: 4, y: 2.5}, // 점프링
                    {x: 52, type: 1, y: 2}, {x: 53, type: 1, y: 2},
                    {x: 53, type: 3, y: 4, id: 1}, // 코인 1
                    {x: 61, type: 2, y: 0}, {x: 62, type: 2, y: 0}, // 2연속 가시
                    ...
                    // ================= 3. 비행기 코스 (적절한 클릭 제어 필요, 무위지안 방지) =================
                    {x: 108, type: 1, y: 0}, {x: 108, type: 1, y: 1}, {x: 108, type: 1, y: 2}, 
                    {x: 120, type: 1, y: 5}, {x: 120, type: 1, y: 6}, {x: 120, type: 1, y: 7}, 
                    
                    {x: 132, type: 2, y: 0}, {x: 132, type: 5, y: 8},
                    {x: 136, type: 1, y: 3}, {x: 136, type: 1, y: 4}, // 정밀 조작 장애물
                    {x: 136, type: 3, y: 1, id: 2}, // 코인 2

                    {x: 148, type: 1, y: 0}, {x: 148, type: 1, y: 1}, {x: 148, type: 1, y: 6}, {x: 148, type: 1, y: 7},
                    {x: 160, type: 1, y: 3}, {x: 160, type: 1, y: 4},
                    {x: 172, type: 2, y: 0}, {x: 172, type: 5, y: 8},

                    // ================= 4. 큐브 포탈 벽 및 차단막 (X: 185) =================
                    {x: 185, type: 1, y: 0},
                    {x: 185, type: 7, y: 1}, // 큐브 포탈
                    {x: 185, type: 1, y: 2},
                    {x: 185, type: 1, y: 3},
                    {x: 185, type: 1, y: 4},
                    {x: 185, type: 1, y: 5},
                    ...
                    // ================= 5. 중간 큐브 코스 =================
                    {x: 196, type: 2, y: 0}, {x: 197, type: 2, y: 0},
                    {x: 206, type: 1, y: 1}, 
                    {x: 212, type: 4, y: 2},
                    {x: 220, type: 1, y: 2},
                    {x: 228, type: 2, y: 0}, {x: 229, type: 2, y: 0},
                    {x: 238, type: 3, y: 3, id: 3}, // 코인 3
                    {x: 245, type: 4, y: 2}, 
                    {x: 254, type: 1, y: 1},

                    // ================= 6. 거미 포탈 벽 및 차단막 (X: 268) =================
                    {x: 268, type: 8, y: 0}, // 거미 포탈
                    {x: 268, type: 1, y: 1},
                    {x: 268, type: 1, y: 2},
                    {x: 268, type: 1, y: 3},
                    {x: 268, type: 1, y: 4},
                    ...
                    // ================= 7. 거미 코스 (지그재그 타이밍 반전) =================
                    {x: 280, type: 2, y: 0}, // 바닥 가시 -> 천장 클릭
                    {x: 292, type: 5, y: 8}, // 천장 가시 -> 바닥 클릭
                    {x: 304, type: 2, y: 0},
                    {x: 314, type: 3, y: 4, id: 4}, // 코인 4
                    {x: 316, type: 5, y: 8},
                    {x: 328, type: 2, y: 0},
                    {x: 340, type: 5, y: 8},

                    // ================= 8. 최종 큐브 포탈 벽 및 피날레 (X: 352~400) =================
                    {x: 352, type: 7, y: 0}, // 큐브 포탈
                    {x: 352, type: 1, y: 1},
                    {x: 352, type: 1, y: 2},
                    {x: 352, type: 1, y: 3},
                    {x: 352, type: 1, y: 4},
                    ...
                    {x: 364, type: 2, y: 0}, {x: 365, type: 2, y: 0},
                    {x: 374, type: 4, y: 2},
                    {x: 384, type: 1, y: 1},
                    {x: 394, type: 2, y: 0}
                ];
            ...
            const FINISH_LINE_X = 405 * BLOCK_SIZE;
            ...
            function update() {
                ...
                if (player.mode === "cube") {
                    ...
                    if (isHolding) player.vy -= 0.80;
                    else player.vy += 0.70;

                    player.vy = Math.max(-7.0, Math.min(7.0, player.vy));
                    player.y += player.vy;
                    player.angle = player.vy * 3.8;
